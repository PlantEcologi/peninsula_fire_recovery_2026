...
mdatwd <- "data/"
mname <- "Landsat_samples_peninsulaMay20262026-05-28" #model name for file naming
...
b <- ggplot(betas) + # Not sure about the covariate order here...
...
# Filter on the the UIJ column of tdat and env
#tdat <- tdat %>% filter(jag_id %in% ids[,2])
#env <- env %>% filter(jag_id %in% ids[,2])
tdat <- tdat %>% filter(UIJ %in% pts$plot)
env <- env %>% filter(UIJ %in% pts$plot)
...
#Fix names
#nms <- data.frame(jag_id = ids[,2], Name = pts$plot)
...
ggsave(filename = "figures/CP_postfire_curves_points_of_interest_Lansdat_w_samples.png", plot = Pcp, device = NULL, path = NULL, scale = 1, width = 36, height = 24, units = "cm", dpi = 300, limitsize = TRUE)
...
ggsave(filename = "figures/CP_MFE_annual_Landsat_sample.png", device = NULL, path = NULL, scale = 1, width = 36, height = 24, units = "cm", dpi = 300, limitsize = TRUE)
...
ggsave(filename = "figures/CP_CRPS_annual_Landsat_sample.png", device = NULL, path = NULL, scale = 1, width = 36, height = 24, units = "cm", dpi = 300, limitsize = TRUE)
...
ggsave(filename = "figures/CP_MFE_timestep_Landsat_sample.png", device = NULL, path = NULL, scale = 1, width = 36, height = 24, units = "cm", dpi = 300, limitsize = TRUE)
...
ggsave(filename = "figures/CP_MFE_ridges_all_Landsat_sample.png", device = NULL, path = NULL, scale = 1, width = 10, height = 24, units = "cm", dpi = 300, limitsize = TRUE)
...
ggsave(filename = "figures/CP_MFE_ridges_plots_Landsat_sample.png", device = NULL, path = NULL, scale = 1, width = 36, height = 50, units = "cm", dpi = 300, limitsize = TRUE)
